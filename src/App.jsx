...
import ToggleGenre from './components/ToggleGenre.jsx'
...
function App() {
  ...
  function toggleGenre(genre) {
    setVisible(prev => ({ ...prev, [genre]: !prev[genre] }))
  }
  ...
  return (
    <>
      ...
      <br />
      <div>
        <ToggleGenre visible={visible} toggleGenre={toggleGenre}/>
      </div>
      <br />
      <div>
        <Display visible={visible} bookData={bookData} />
      </div>
    </>
  )
}
